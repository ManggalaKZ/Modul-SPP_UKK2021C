...
public class DataKelasAdapter extends RecyclerView.Adapter<com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataKelasAdapter.ViewHolder> {
    ...
    public void setOnRecyclerViewItemClickListener(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataKelasAdapter.OnRecyclerViewItemClickListener listener) {
        mListener = listener;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.detailKelas.setOnClickListener(v -> {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.dialog_view_kelas, v.findViewById(R.id.layoutDialogContainer));
            ...
            view.findViewById(R.id.buttonEdit).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    alertDialog.dismiss();
                    AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.AlertDialogTheme);
                    View view2 = LayoutInflater.from(context).inflate(R.layout.dialog_tambah_kelas, v.findViewById(R.id.layoutDialogContainer));
