...
public class DataSiswaAdapter extends RecyclerView.Adapter<com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaAdapter.ViewHolder> {
    ...
    public void setOnRecyclerViewItemClickListener(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaAdapter.OnRecyclerViewItemClickListener listener) {
        mListener = listener;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.detailSiswa.setOnClickListener(v -> {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.dialog_view_siswa, v.findViewById(R.id.layoutDialogContainer));
