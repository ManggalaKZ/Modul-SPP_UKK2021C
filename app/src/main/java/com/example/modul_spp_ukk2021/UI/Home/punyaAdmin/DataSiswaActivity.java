...
public class DataSiswaActivity extends AppCompatActivity {
                ...
                call.enqueue(new Callback<SiswaRepository>() {
                    ...
                    public void onResponse(Call<SiswaRepository> call, Response<SiswaRepository> response) {
                        ...
                        if (value.equals("1")) {
                            ...
                            Toast.makeText(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaActivity.this, message, Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<SiswaRepository> call, Throwable t) {
                        ...
                        Toast.makeText(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaActivity.this, "Gagal koneksi sistem, silahkan coba lagi..." + " [" + t.toString() + "]", Toast.LENGTH_LONG).show();
                        Log.e("DEBUG", "Error: ", t);
                    }
                });
        ...
        call.enqueue(new Callback<SiswaRepository>() {
            ...
            public void onResponse(Call<SiswaRepository> call, Response<SiswaRepository> response) {
                ...
                if (value.equals("1")) {
                    ...
                    adapter = new DataSiswaAdapter(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaActivity.this, siswa);
    ...
    private void DialogTambah() {
        AlertDialog.Builder builder = new AlertDialog.Builder(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaActivity.this, R.style.AlertDialogTheme);
        View view = LayoutInflater.from(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaActivity.this).inflate(R.layout.pa_dialog_tambah_siswa, findViewById(R.id.layoutDialogContainer));
        ...
        PopupMenu dropDownMenu = new PopupMenu(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaActivity.this, spp_siswa);
        ...
        view.findViewById(R.id.buttonKirim).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (id_spp != null && nama_siswa.getText().toString().trim().length() > 0 && NISN_siswa.getText().toString().trim().length() == 10 && NIS_siswa.getText().toString().trim().length() == 8 && alamat_siswa.getText().toString().trim().length() > 0 && ponsel_siswa.getText().toString().trim().length() > 0 && password_siswa.getText().toString().trim().length() > 0) {
                    ...
                    Toast.makeText(com.example.modul_spp_ukk2021.UI.Home.punyaAdmin.DataSiswaActivity.this, "Data belum lengkap, silahkan coba lagi", Toast.LENGTH_SHORT).show();
                }
            }
        });
